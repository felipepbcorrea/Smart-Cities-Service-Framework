...
<html>
    ...
    <center>
        ...
        <% 
            ...
            out.print("<tr>");
            out.print("<th>TABELA</th><th>COLUNA</th><th>TIPO</th><th>TAMANHO</th><th>NOT NULL</th><th>AUTO INCREMENT</th><th>PK</th><th>FK</th><th>TABELA FK</th><th>AÇÃO</th>");
            out.print("</tr>");
        ...
        <form action="inserirDados.jsp">
            <input type="submit" value="ADICIONAR NOVO DADO" style="width: 250px; height: 80px">   
        </form>
        <br><br>
        <form action="dadosConexaoMySQL.jsp">
            <input type="submit" value="GERAR BANCO DE DADOS" style="width: 250px; height: 80px">   
        </form>
        <br><br>
